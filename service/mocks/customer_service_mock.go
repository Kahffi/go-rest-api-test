...
func (mr *MockCustomerServiceMockRecorder) Delete(ctx, customerId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCustomerServiceMockRecorder) FindById(ctx, customerId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
